...
| [Orchestration Manager Guide](docs/06_Orchestration_v11.md) | Full setup, gate-by-gate operations, failure handling (v11: adds Claude.ai project-structure guidance for multi-app builds) |
...
- **Pipeline failures:** See the [Orchestration Manager Guide](docs/06_Orchestration_v11.md) failure handling section
