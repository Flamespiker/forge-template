...
**Current version: v10** (2026-08-31) — see the v10 update note below for what changed.
...
**Status: substantially complete as of the 2026-08-31 reconciliation** (see v10 update note above). REQ-2026-04 (coverage-history view for REQ-2026-03) proved the full enhancement path end-to-end — Stage 0a through Deploy, live in staging, visually confirmed by Mike. One genuine open gap surfaced (7.7, ADO Epic linkage — Backlog Item #32), and `forge-template#10` remains open pending a bookkeeping decision to close it.
...
- [ ] 7.7 Confirm ADO bug parent links correctly to the original User Story (or a new one under the existing Epic) *(2026-08-31 reconciliation — attempted but did NOT land as intended: `create_ado_items.py` created a brand-new Epic #169 with its own Features/User Stories, entirely unlinked to REQ-2026-03's actual existing Epic #134. The one QA bug filed (#178) is parent-linked to a User Story under the new #169, not to anything under #134. The mechanism has no "attach to existing Epic" concept at all — this is a real design gap, not just an unconfirmed step. Logged as Backlog Item #32 for Mike's call on how ADO linkage should work for Enhancements going forward.)*
